        ...
        <div class="row">
            <div class="col-md-2">
                <div class="list-group">
                    ...
                    <a href="admin_carousel.php" class="list-group-item list-group-item-action bg-warning">輪播圖圖片</a>
                                    ...
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-md-2">
                                            <div class="card-body d-flex justify-content-center align-items-center">
                                                ...
                                                <img class="card-img mx-auto" src="<?php echo $row['path']; ?>" alt="<?php echo $row['filename']; ?>" style="max-height: 50px; width: auto; object-fit: contain;">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-2">
                                            <div class="card-body d-flex justify-content-center align-items-center mt-2">
                                                <button type="submit" class="btn btn-success btn-warning">修改</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
